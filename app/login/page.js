        ...
        >
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-300">Welcome back to FINEX CORP!</p>
            </div>
            ...
            <p className="text-center text-sm text-gray-300">
              ...
              <Link href="/register" className="font-semibold text-primary hover:text-accent transition">
                Sign up
              </Link>
            </p>
          </div>
